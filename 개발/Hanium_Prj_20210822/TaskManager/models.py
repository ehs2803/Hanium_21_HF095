...
class CompleteList(models.Model):
    ...
    end_time = models.CharField(db_column='END_TIME', max_length=150, blank=True, null=True)  # Field name made lowercase.
...
class TodoList(models.Model):
    ...
    username = models.CharField(max_length=150)
    content = models.TextField(blank=True, null=True)
    reg_time = models.CharField(max_length=150, blank=True, null=True)
    reg_date = models.CharField(max_length=150, blank=True, null=True)
