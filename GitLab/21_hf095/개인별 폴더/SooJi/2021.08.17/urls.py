...
urlpatterns = [
    ...
    path('test/createTodo/', views.createTodo, name='createTodo'),
    path('test/deleteTodo/', views.deleteTodo, name='deleteTodo'),
    path('test/completeTodo/', views.completeTodo, name='completeTodo'),
    path('test/selectTodo/', views.selectTodo, name='selectTodo'),
